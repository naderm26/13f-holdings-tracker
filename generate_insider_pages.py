...
def build_page(ticker, data):
    ...
    rows_html = "\n".join(tx_row(t, i) for i, t in enumerate(txs)) if txs else \
        '<tr><td colspan="9" style="text-align:center;color:var(--muted);padding:2rem">No insider transactions in the last 90 days.</td></tr>'
  ...
  <table>
    <thead>
      <tr>
        ...
        <th class="left" style="width:25%">Insider</th>
        <th>Type</th>
        <th>Shares</th>
        <th>Price</th>
        <th>Value</th>
